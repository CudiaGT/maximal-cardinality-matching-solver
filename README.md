...
As the approximation bound from augmenting path length states that when the shortest augmenting paths have length &ge; 2𝑘−1, then the current matching is at least (1−1/𝑘)⋅𝑂𝑃𝑇.
