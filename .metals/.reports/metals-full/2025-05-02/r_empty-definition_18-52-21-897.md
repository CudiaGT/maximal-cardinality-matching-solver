error id: subtract.
file://<WORKSPACE>/src/main/scala/final_project/augmenting_path_improver.scala
empty definition using pc, found symbol in pc: subtract.
...
non-local guesses:
	 ...
	 -allEdges/subtract#
	 -allEdges/subtract().
	 -scala/Predef.allEdges.subtract.
	 -scala/Predef.allEdges.subtract#
	 -scala/Predef.allEdges.subtract().
offset: 2269
uri: file://<WORKSPACE>/src/main/scala/final_project/augmenting_path_improver.scala
text:
```scala
...
object augmenting_path_improver {
  def main(args: Array[String]): Unit = {
    ...
    while (iteration < maxIterations && improvementFound) {
      ...
      val residualEdges = allEdges.subt@@ract(currentMatching).persist(StorageLevel.DISK_ONLY)
